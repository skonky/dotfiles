# Generated by Powerlevel10k configuration wizard on 2022-09-28 at 16:18 CEST.
...
() {
  ...
  # automatically hidden when the input180 line reaches it. Right prompt above the
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local conflicted='%17F'  # red foreground
    else
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_VCS_PREFIX='%7F on '
  ...
  function bitcoin_ticker() {
    p10k segment -f 208 -i '*' -t $(~/scripts/bitcoin.sh)
  }
